...
export class ActivitiesController {
  ...
  @ApiOperation({ 
    ...
    description: 'Endpoint ini mendukung pagination, pencarian, filtering berdasarkan name dan status, dan sorting berdasarkan field tertentu'
  })
  @SwaggerApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Melakukan soft delete pada aktivitas (data tidak benar-benar dihapus dari database)'
  })
  @SwaggerApiResponse({ 
    status: 200, 
