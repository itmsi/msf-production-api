...
import { CreateMenuDto, UpdateMenuDto, MenuResponseDto, GetMenusQueryDto } from './dto/menu.dto';
...
export class MenuController {
  ...
  @ApiQuery({ name: 'search', required: false, description: 'Search term for menu_name or menu_code' })
  @ApiQuery({ name: 'module', required: false, description: 'Filter by module (spare-part, production)' })
  @ApiQuery({ name: 'status', required: false, description: 'Filter by status (active, inactive)' })
  @ApiQuery({ name: 'is_parent', required: false, description: 'Filter by is_parent (true, false)' })
  @ApiQuery({ name: 'parent_id', required: false, description: 'Filter by parent_id' })
  @ApiQuery({ name: 'sortBy', required: false, description: 'Sort by field (default: sort_order)' })
  @ApiQuery({ name: 'sortOrder', required: false, description: 'Sort order (ASC, DESC, default: ASC)' })
  @ApiResponse({ 
    status: 200, 
