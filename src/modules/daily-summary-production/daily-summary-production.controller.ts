...
import { DailySummaryProductionQueryDto, DailySummaryProductionResponseDto } from './dto/daily-summary-production.dto';
...
export class DailySummaryProductionController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve daily summary production data with loss time information (rain and slippery duration) with optional filters for date range, DT type, and material type',
  })
  @ApiQuery({
    name: 'startDate',
