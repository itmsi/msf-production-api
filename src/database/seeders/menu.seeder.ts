  ...
  async run(): Promise<void> {
    const menusData = [
      ...
      // Overall Performance (sub menu dari dashboard)
      {
        ...
        menuCode: 'OVERALL_PERFORMANCE',
        icon: 'analytics',
        url: '/dashboard/overall-performance',
        isParent: false,
        sortOrder: 1,
      ...
      {
        menuName: 'Monthly Production Performance',
        menuCode: 'MONTHLY_PRODUCTION_PERFORMANCE',
        icon: 'bar_chart',
        url: '/dashboard/overall-performance/monthly',
        isParent: false,
        sortOrder: 1,
        parentCode: 'OVERALL_PERFORMANCE',
        module: 'production',
      },
      ...
      {
        menuName: 'Hauling Performance',
        menuCode: 'HAULING_PERFORMANCE',
        icon: 'local_shipping',
        url: '/dashboard/ccr-hourly/hauling',
        isParent: false,
        sortOrder: 1,
        parentCode: 'CCR_HOURLY',
        module: 'production',
      },

      // Barging Performance (sub menu dari CCR Hourly)
      {
        menuName: 'Barging Performance',
        menuCode: 'BARGING_PERFORMANCE',
        icon: 'local_shipping',
        url: '/dashboard/ccr-hourly/barging',
        isParent: false,
        sortOrder: 2,
        parentCode: 'CCR_HOURLY',
        module: 'production',
      ...
      {
        menuName: 'View Data Page',
        menuCode: 'VIEW_DATA_PAGE',
        icon: 'visibility',
        url: null,
        isParent: true,
        sortOrder: 2,
      ...
      {
        menuName: 'Control Page',
        menuCode: 'CONTROL_PAGE',
        icon: 'control_camera',
        url: '/view-data/control',
        isParent: false,
        sortOrder: 1,
        parentCode: 'VIEW_DATA_PAGE',
        module: 'production',
      },

      // Control Day Production (sub menu dari Control Page)
      {
        menuName: 'Control Day Production',
        menuCode: 'CONTROL_DAY_PRODUCTION',
        icon: 'production_quantity_limits',
        url: '/view-data/control/day-production',
        isParent: false,
        sortOrder: 1,
        parentCode: 'CONTROL_PAGE',
        module: 'production',
      },

      // Control Day Work Hour (sub menu dari Control Page)
      {
        menuName: 'Control Day Work Hour',
        menuCode: 'CONTROL_DAY_WORK_HOUR',
        icon: 'schedule',
        url: '/view-data/control/day-work-hour',
        isParent: false,
        sortOrder: 2,
        parentCode: 'CONTROL_PAGE',
        module: 'production',
      ...
      {
        menuName: 'Control Shift Production',
        menuCode: 'CONTROL_SHIFT_PRODUCTION',
        icon: 'production_quantity_limits',
        url: '/view-data/control/shift-production',
        isParent: false,
        sortOrder: 3,
        parentCode: 'CONTROL_PAGE',
        module: 'production',
      ...
      {
        menuName: 'Control Shift Work Hour',
        menuCode: 'CONTROL_SHIFT_WORK_HOUR',
        icon: 'schedule',
        url: '/view-data/control/shift-work-hour',
        isParent: false,
        sortOrder: 4,
        parentCode: 'CONTROL_PAGE',
        module: 'production',
      ...
      {
        menuName: 'Summary Production',
        menuCode: 'SUMMARY_PRODUCTION',
        icon: 'summarize',
        url: '/view-data/summary-production',
        isParent: false,
        sortOrder: 2,
        parentCode: 'VIEW_DATA_PAGE',
        module: 'production',
      ...
      {
        menuName: 'Analysis Barge & Hauling',
        menuCode: 'ANALYSIS_BARGE_HAULING',
        icon: 'analytics',
        url: '/view-data/analysis-barge-hauling',
        isParent: false,
        sortOrder: 3,
        parentCode: 'VIEW_DATA_PAGE',
        module: 'production',
      ...
      {
        menuName: 'Entry Data Page',
        menuCode: 'ENTRY_DATA_PAGE',
        icon: 'edit',
        url: null,
        isParent: true,
        sortOrder: 3,
      ...
      // Work Plan (sub menu dari Entry Data Page)
      {
        ...
        menuCode: 'WORK_PLAN',
        icon: 'work',
        url: '/entry-data/work-plan',
        isParent: false,
        sortOrder: 1,
        parentCode: 'ENTRY_DATA_PAGE',
        module: 'production',
      },

      // Daily Working Hour Plan List (sub menu dari Work Plan)
      {
        menuName: 'Daily Working Hour Plan List',
        menuCode: 'DAILY_WORKING_HOUR_PLAN_LIST',
        icon: 'schedule',
        url: '/entry-data/work-plan/daily-working-hour',
        isParent: false,
        sortOrder: 1,
        parentCode: 'WORK_PLAN',
        module: 'production',
      },

      // Settings Daily Working Hour Plan (sub menu dari Work Plan)
      {
        menuName: 'Settings Daily Working Hour Plan',
        menuCode: 'SETTINGS_DAILY_WORKING_HOUR_PLAN',
        icon: 'settings',
        url: '/entry-data/work-plan/settings-daily-working-hour',
        isParent: false,
        sortOrder: 2,
        parentCode: 'WORK_PLAN',
        module: 'production',
      ...
      {
        menuName: 'Daily Production Plan List',
        menuCode: 'DAILY_PRODUCTION_PLAN_LIST',
        icon: 'production_quantity_limits',
        url: '/entry-data/work-plan/daily-production',
        isParent: false,
        sortOrder: 3,
        parentCode: 'WORK_PLAN',
        module: 'production',
      ...
      {
        menuName: 'Settings Daily Production Plan',
        menuCode: 'SETTINGS_DAILY_PRODUCTION_PLAN',
        icon: 'settings',
        url: '/entry-data/work-plan/settings-daily-production',
        isParent: false,
        sortOrder: 4,
        parentCode: 'WORK_PLAN',
        module: 'production',
      ...
      {
        menuName: 'MTD Production',
        menuCode: 'MTD_PRODUCTION',
        icon: 'trending_up',
        url: '/entry-data/mtd-production',
        isParent: false,
        sortOrder: 2,
        parentCode: 'ENTRY_DATA_PAGE',
        module: 'production',
      ...
      {
        menuName: 'Production List',
        menuCode: 'PRODUCTION_LIST',
        icon: 'list',
        url: '/entry-data/mtd-production/production-list',
        isParent: false,
        sortOrder: 1,
        parentCode: 'MTD_PRODUCTION',
        module: 'production',
      },

      // Loss Time List (sub menu dari MTD Production)
      {
        menuName: 'Loss Time List',
        menuCode: 'LOSS_TIME_LIST',
        icon: 'schedule',
        url: '/entry-data/mtd-production/loss-time-list',
        isParent: false,
        sortOrder: 2,
        parentCode: 'MTD_PRODUCTION',
        module: 'production',
      ...
      // Barge List (sub menu dari MTD Production)
      {
        ...
        menuCode: 'BARGE_LIST',
        icon: 'local_shipping',
        url: '/entry-data/mtd-production/barge-list',
        isParent: false,
        sortOrder: 3,
        parentCode: 'MTD_PRODUCTION',
        module: 'production',
      ...
      {
        menuName: 'Fuel Consumption List',
        menuCode: 'FUEL_CONSUMPTION_LIST',
        icon: 'local_gas_station',
        url: '/entry-data/mtd-production/fuel-consumption-list',
        isParent: false,
        sortOrder: 4,
        parentCode: 'MTD_PRODUCTION',
        module: 'production',
      ...
      {
        menuName: 'CCR Hourly',
        menuCode: 'CCR_HOURLY_ENTRY',
        icon: 'schedule',
        url: '/entry-data/ccr-hourly',
        isParent: false,
        sortOrder: 3,
        parentCode: 'ENTRY_DATA_PAGE',
        module: 'production',
      ...
      {
        menuName: 'CCR Hauling List',
        menuCode: 'CCR_HAULING_LIST',
        icon: 'local_shipping',
        url: '/entry-data/ccr-hourly/hauling-list',
        isParent: false,
        sortOrder: 1,
        parentCode: 'CCR_HOURLY_ENTRY',
        module: 'production',
      },

      // CCR Barging List (sub menu dari CCR Hourly)
      {
        menuName: 'CCR Barging List',
        menuCode: 'CCR_BARGING_LIST',
        icon: 'local_shipping',
        url: '/entry-data/ccr-hourly/barging-list',
        isParent: false,
        sortOrder: 2,
        parentCode: 'CCR_HOURLY_ENTRY',
        module: 'production',
      ...
      {
        menuName: 'CCR Problem Hauling List',
        menuCode: 'CCR_PROBLEM_HAULING_LIST',
        icon: 'error',
        url: '/entry-data/ccr-hourly/problem-hauling-list',
        isParent: false,
        sortOrder: 3,
        parentCode: 'CCR_HOURLY_ENTRY',
        module: 'production',
      ...
      {
        menuName: 'CCR Problem Barging List',
        menuCode: 'CCR_PROBLEM_BARGING_LIST',
        icon: 'error',
        url: '/entry-data/ccr-hourly/problem-barging-list',
        isParent: false,
        sortOrder: 4,
        parentCode: 'CCR_HOURLY_ENTRY',
        module: 'production',
      ...
      {
        menuName: 'Master Data Page',
        menuCode: 'MASTER_DATA_PAGE',
        icon: 'database',
        url: null,
        isParent: true,
        sortOrder: 4,
      ...
      // Unit Type (sub menu dari Master Data Page)
      {
        ...
        menuCode: 'UNIT_TYPE',
        icon: 'category',
        url: '/master-data/unit-type',
        isParent: false,
        sortOrder: 1,
        parentCode: 'MASTER_DATA_PAGE',
        module: 'production',
      },

      // COA Population List (sub menu dari Master Data Page)
      {
        menuName: 'COA Population List',
        menuCode: 'COA_POPULATION_LIST',
        icon: 'group_work',
        url: '/master-data/coa-population-list',
        isParent: false,
        sortOrder: 2,
        parentCode: 'MASTER_DATA_PAGE',
        module: 'production',
