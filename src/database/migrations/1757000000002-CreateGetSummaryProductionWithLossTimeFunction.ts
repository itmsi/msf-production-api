...
export class CreateGetSummaryProductionWithLossTimeFunction1757000000002 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      BEGIN
          ...
          FROM base
          GROUP BY base.tyre_type, base.date_arrive, base.material;
      END;
      $$ LANGUAGE plpgsql;
    `);
  }
