...
export class UpdateDateColumnsToDatetime1700000000031 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_plan_working_hour ALTER COLUMN plan_date TYPE timestamp');
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_ccr_hauling ALTER COLUMN activity_date TYPE timestamp');
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_input_barge ALTER COLUMN start_loading TYPE timestamp');
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_input_barge ALTER COLUMN end_loading TYPE timestamp');
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE m_population ALTER COLUMN date_arrive TYPE timestamp');
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    try {
      ...
      await queryRunner.query('ALTER TABLE r_base_data_pro ALTER COLUMN activity_date TYPE date');
    } catch (error) {
      console.log('Table r_base_data_pro or column activity_date not found, skipping...');
    }
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_plan_production ALTER COLUMN plan_date TYPE date');
    } catch (error) {
      console.log('Table r_plan_production or column plan_date not found, skipping...');
    }
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_plan_working_hour ALTER COLUMN plan_date TYPE date');
    } catch (error) {
      console.log('Table r_plan_working_hour or column plan_date not found, skipping...');
    }
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_ccr_hauling ALTER COLUMN activity_date TYPE date');
    } catch (error) {
      console.log('Table r_ccr_hauling or column activity_date not found, skipping...');
    }
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_input_barge ALTER COLUMN start_loading TYPE date');
    } catch (error) {
      console.log('Table r_input_barge or column start_loading not found, skipping...');
    }
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE r_input_barge ALTER COLUMN end_loading TYPE date');
    } catch (error) {
      console.log('Table r_input_barge or column end_loading not found, skipping...');
    }
    ...
    try {
      ...
      await queryRunner.query('ALTER TABLE m_population ALTER COLUMN date_arrive TYPE date');
    } catch (error) {
      console.log('Table m_population or column date_arrive not found, skipping...');
    }
  }
