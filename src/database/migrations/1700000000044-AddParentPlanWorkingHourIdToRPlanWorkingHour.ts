...
export class AddParentPlanWorkingHourIdToRPlanWorkingHour1700000000044 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (table) {
      const foreignKey = table.foreignKeys.find((fk) => fk.columnNames.indexOf('parent_plan_working_hour_id') !== -1);
      if (foreignKey) {
