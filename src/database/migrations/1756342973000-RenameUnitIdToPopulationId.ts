...
export class RenameUnitIdToPopulationId1756342973000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "r_parent_base_data_pro" ADD CONSTRAINT "FK_parent_base_data_pro_population" FOREIGN KEY ("population_id") REFERENCES "m_population"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
    );
