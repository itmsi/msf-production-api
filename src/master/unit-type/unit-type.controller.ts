...
export class UnitTypeController {
  ...
  @ApiOperation({ 
    ...
    description: 'Endpoint ini mendukung pagination, pencarian, filtering berdasarkan brand_id, unit_name, type_name, model_name, dan sorting berdasarkan field tertentu'
  })
  @SwaggerApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Membuat unit type baru dengan validasi duplikasi kombinasi brand_id, unit_name, type_name, dan model_name'
  })
  @SwaggerApiResponse({ 
    status: 201, 
  ...
  @ApiOperation({ 
    ...
    description: 'Mengupdate data unit type dengan validasi duplikasi kombinasi brand_id, unit_name, type_name, dan model_name'
  })
  @SwaggerApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Melakukan soft delete pada unit type (data tidak benar-benar dihapus dari database)'
  })
  @SwaggerApiResponse({ 
    status: 200, 
